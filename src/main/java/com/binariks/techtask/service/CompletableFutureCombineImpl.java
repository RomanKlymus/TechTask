...
public class CompletableFutureCombineImpl implements TaskService {
    ...
    @Autowired
    public CompletableFutureCombineImpl(MongoDBRepo mongoDBRepo, MySQLRepo mySQLRepo) {
    ...
    public Set<User> run() {
        ...
        firstProcess.thenCombineAsync(secondProcess, (o, o2) -> writeToMongoDB());
        firstProcess.thenCombineAsync(secondProcess, (o, o2) -> writeToMySQL());
        try {
            secondProcess.get();
